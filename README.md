...
# Data Flow Chart
The project data flow chart can be found [here](https://www.lucidchart.com/documents/view/f229f659-229a-476c-b65d-6d1e424b4c73). The symbols used may be incorrect but we are working to verify that chart standars are being followed.
